...
exports.getCarUser = async (req, res, next) => {
    try {
...
exports.postCarUser = [carUserValidationRules(), async (req, res, next) => {
    try {
...
exports.putCarUser = [carUserValidationRules(), async (req, res, next) => {
    try {
      const errors = validationResult(req);
      if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
...
exports.patchCarUser = async (req, res, next) => {
    try {
...
exports.deleteCarUser = async (req, res, next) => {
    try {
